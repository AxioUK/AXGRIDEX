...
Public Property Get TextPosition() As AlignmentConstants
  TextPosition = lTextPos
  
End Property

Public Property Let TextPosition(TextPosition As AlignmentConstants)
  lTextPos = TextPosition
  Call Redraw(lastStat, True)
End Property
